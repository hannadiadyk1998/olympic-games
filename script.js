...
const getFlagByCountry = country =>{
    let countryInfo = flags
        .find(item => item [0] === country );
...
const renderTbody = () => {
  const TRs = sports.map( sport => {
    ...
    let currenWinners = getWinnersBysport( sportName);
    console.log(sportName,currenWinners);
    
    currenWinners.forEach(winner => {
        ...
        console.log(winner, winnerContinent);
    })
